        ...
        if table[index] is not None:
            for word in word_bank:
                ...
                if target_str[index : end_index] == word:
                    ...
                    if (table[end_index] is None) or (
                        len(table[end_index]) >= len(table[index]) + 1):
...
print(word_construct('abcd', ['a', 'b', 'cd', 'fd', 'c', 'bc' ]))
print(word_construct('abcde', ['ab', 'd', 'de', 'c', ]))
print(word_construct('eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeef',
        ['e', 'eeee', 'eeeeeee', 'eeeeeeeeeeeeeeeeee', 'eeef' ]))
